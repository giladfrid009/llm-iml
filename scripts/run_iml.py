...
def run_attack(adv_model: AdvModel, evaluators: list[Evaluator], dl_train: DF_Batcher, dl_eval: DF_Batcher):
    ...
    optimizer = optim.AdamW(adv_model.parameters(), lr=2e-2, weight_decay=0.001)

    activ_extractor = ActivationExtractor(adv_model.model, "lm_head", capture_output=True)
