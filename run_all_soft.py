...
MODELS = {
    ...
    "llama_2_cat": {
        "nick": "soft-llama2-cat",
        "experiments": {"setup": EXP_SETUP},
        # CLI Arguments
        "model": "ContinuousAT/Llama-2-7B-CAT",
    },
    "mistral_r2d2": {
        "nick": "soft-mistral-r2d2",
        "experiments": {"setup": EXP_SETUP},
        # CLI Arguments
    ...
    "llama_3_lat": {
        "nick": "soft-llama3-lat",
        "experiments": {"setup": EXP_SETUP},
        # CLI Arguments
        "model": "LLM-LAT/robust-llama3-8b-instruct",
    },
    "phi_3_capo": {
        "nick": "soft-phi-3-capo",
        "experiments": {"setup": EXP_SETUP},
        # CLI Arguments
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Run consolidated Soft-Prompt experiments.")
